...
npm install @radix-ui/react-tabs @radix-ui/react-select @radix-ui/react-progress @radix-ui/react-separator @radix-ui/react-slot class-variance-authority clsx tailwind-merge
